...
# user_name = 'user'
save_npy_path = '/scratch/PI/cqf/har_data/nturgb+d_skl/'
load_txt_path = '/scratch/PI/cqf/har_data/nturgb+d_skeletons/'
...
if __name__ == '__main__':
    ...
    for ind, each in enumerate(datalist):
        ...
        print(each)
        mat = _read_skeleton(loadname, save_skelxyz=False, save_rgbxy=True, save_depthxy=False)
        mat = np.array(mat)
